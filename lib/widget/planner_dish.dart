...
class PlannerDish extends StatefulWidget {
  final String isType;
  const PlannerDish({super.key, required this.isType});

  @override
  State<PlannerDish> createState() => _PlannerDishState();
}

class _PlannerDishState extends State<PlannerDish> {
  @override
