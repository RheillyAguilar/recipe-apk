...
class PlannerSnack extends StatefulWidget {
  final Food? food;
  final String isType;
  
  const PlannerSnack({super.key, required this.isType, this.food});

  @override
  State<PlannerSnack> createState() => _PlannerSnackState();
}

class _PlannerSnackState extends State<PlannerSnack> {
  @override
